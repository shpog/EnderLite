package test.EnderLite.DummyServer;
...
public class DummyServer{
    private ConcurrentLinkedQueue<String> userInput;
    public int port_num;
    ...
    public void start(){
            ...
            public void run(){
                ...
                while(true){
                    ...
                    try{
                        ...
                        System.err.println("Error while handling user input!");
                        try{
                            reader.close();
                        } catch (IOException t){
        ...
        if (handshakeTest()){ //code after handshake if handshakeOnly false
            ...
            userInput = new ConcurrentLinkedQueue<String>();
            initCipher();
            while (true){
                if (!userInput.isEmpty()){
                    String command = userInput.poll();
    ...
    public String readAndDecipher(){
        ...
        try{
            ...
            System.out.println("[Error]Error while receiving message (ReceiverServer)");
            return null;
        }
        ...
        try{
            ...
            System.out.println("[Error] BadPaddingException cipher (ReceiverServer)");
        } catch (IllegalBlockSizeException e) {
            System.out.println("[Error] IllegalBlockSizeException cipher (ReceiverServer)");
        }
    ...
    private void initCipher(){
        try {
            ...
            System.out.println("[Error] InvalidKeyException cipher (Receiver)");
        } catch (NoSuchAlgorithmException e) {
            System.out.println("[Error] NoSuchAlgorithmException cipher (Receiver)");
        } catch (NoSuchProviderException e) {
            System.out.println("[Error] NoSuchProviderException cipher (Receiver)");
        } catch (NoSuchPaddingException e) {
            System.out.println("[Error] NoSuchPaddingException cipher (Receiver)");
        }
    }
    ...
    public void encryptAndSend(String message){
        ...
        try {
            ...
            System.err.println("[Error] IllegalBlockSizeException cipher (TransmitterSever)");
        } catch (BadPaddingException e) {
            System.err.println("[Error] BadPaddingException cipher (TransmitterServer)");
        }
        try {
            socOut.writeLong(encryptedMessage.length);
            socOut.write(encryptedMessage);
        } catch (IOException e) {
            System.err.println("[Error] Error while sending message (TransmitterServer)");
        }
    }
